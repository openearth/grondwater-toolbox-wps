...
from processes.brl_wps_abstraction import WpsBRLAbstraction
from processes.brl_wps_modelprofile import WpsBRLmodelprofile
from processes.brl_wps_digit import WpsBRLDigit
from processes.brl_wps_drainage import WpsBRLDrainage
from processes.brl_wps_watersystem import WpsBRLWatersystem

processes = [
    WpsBRLmodelprofile(), WpsBRLAbstraction(),UltimateQuestion(),WpsBRLWatercourse(),WpsBRLInit(),WpsBRLGWModel(),WpsBRLDigit(), WpsBRLDrainage(),WpsBRLWatersystem()
]
