...
class WpsBRLWatercourse(Process):
	...
	def _handler(self, request, response):
		try:
			...
			waterLines,waterPoly,watersCentr = get_waters_geojson(cf, area_jsonstr)
			...
			centrPt = open(os.path.join(tmpdir, watersId+'_centr_rd.geojson'), 'w')
			centrPt.write(watersCentr)
