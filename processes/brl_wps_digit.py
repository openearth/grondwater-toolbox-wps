...
class WpsBRLDigit(Process):
    def __init__(self):
        ...
        super(WpsBRLDigit, self).__init__(
            ...
            version="1.0",
            title="Calculate the effect of excavation",
            abstract="This process models the effects of measures in bedlevel (excavation) and returns stages and vertical fluxes as output. This Groundwatertoolbox tool expects, area drawn by user, layer (1-7), area of interest.",
            profile="",
