...
class WpsBRLAbstraction(Process):
	...
	def __init__(self):
		...
		super(WpsBRLAbstraction, self).__init__(
		    ...
		    version='1.0',
		    title='Calculate effect of abstraction',
		    abstract='This process models the effects of an abstraction and returns stages and vertical fluxes as output. This Groundwatertoolbox tool expects, point location, layer (1-nlay), area of interest and resolution of the output.',
		    profile='',
