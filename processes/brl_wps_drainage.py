...
class WpsBRLDrainage(Process):
    def __init__(self):
        ...
        super(WpsBRLDrainage, self).__init__(
            ...
            version="1.0",
            title="Calculate the effect of a change in drainage parameters",
            abstract="This Groundwatertoolbox tool expects and area drawn by a user, layer (1-7), area of interest and horizontal calculation resolution. This process models the effects of measures of changes in drainage pattern (resistance, elevation) and returns stages and vertical fluxes as output.",
            profile="",
